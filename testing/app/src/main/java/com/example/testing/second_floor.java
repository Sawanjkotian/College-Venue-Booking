...
public class second_floor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayout venueSecondfloorLayout = findViewById(R.id.venueSecondfloor);

        // Retrieve the bookings for the Netravati venue
        DatabaseReference venueBookingsRef = databaseRef.child("venues").child("Second floor seminar hall");
                        ...
                        for (DataSnapshot userSnapshot : timeSnapshot.getChildren()) {
                            ...
                            userRef.addListenerForSingleValueEvent(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                    ...
                                    venueSecondfloorLayout.addView(venueItemView);
                                }
