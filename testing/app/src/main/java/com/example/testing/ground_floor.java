...
public class ground_floor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayout venueGroundfloorLayout = findViewById(R.id.venueGroundfloor);

        // Retrieve the bookings for the Netravati venue
        DatabaseReference venueBookingsRef = databaseRef.child("venues").child("First floor seminar hall");
                        ...
                        for (DataSnapshot userSnapshot : timeSnapshot.getChildren()) {
                            ...
                            userRef.addListenerForSingleValueEvent(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                    ...
                                    venueGroundfloorLayout.addView(venueItemView);
                                }
