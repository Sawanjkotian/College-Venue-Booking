...
public class back_ground extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayout venueBackGroundLayout = findViewById(R.id.venueBackGround);

        // Retrieve the bookings for the Netravati venue
        DatabaseReference venueBookingsRef = databaseRef.child("venues").child("Back ground");
                        ...
                        for (DataSnapshot userSnapshot : timeSnapshot.getChildren()) {
                            ...
                            userRef.addListenerForSingleValueEvent(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                    ...
                                    venueBackGroundLayout.addView(venueItemView);
                                }
