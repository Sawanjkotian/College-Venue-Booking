...
public class front_ground extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_front_ground);

        DatabaseReference databaseRef = FirebaseDatabase.getInstance().getReference();

        // Get reference to the venueNetravati LinearLayout
        LinearLayout venueFrontGroundLayout = findViewById(R.id.venueFrontGround);

        // Retrieve the bookings for the Netravati venue
        DatabaseReference venueBookingsRef = databaseRef.child("venues").child("Front ground");
                        ...
                        for (DataSnapshot userSnapshot : timeSnapshot.getChildren()) {
                            ...
                            userRef.addListenerForSingleValueEvent(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                    ...
                                    venueFrontGroundLayout.addView(venueItemView);
                                }
