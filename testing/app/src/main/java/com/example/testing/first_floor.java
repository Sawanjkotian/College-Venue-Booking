...
public class first_floor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayout venueFirstfloorLayout = findViewById(R.id.venueFirstfloor);

        // Retrieve the bookings for the Netravati venue
        DatabaseReference venueBookingsRef = databaseRef.child("venues").child("Ground floor seminar hall");
                        ...
                        for (DataSnapshot userSnapshot : timeSnapshot.getChildren()) {
                            ...
                            userRef.addListenerForSingleValueEvent(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                    ...
                                    venueFirstfloorLayout.addView(venueItemView);
                                }
